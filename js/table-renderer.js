                ...
                var paginationObj = function () {
                    ...
                    paginationObj.prototype.generateHtml = function() {
                        if(this.params.type === 'page') {
                            return '<span class="to-page btn btn-primary btn-flat">'+ this.params.pageNumber +'</span>';
                        }else if(this.params.type === 'activePage') {
                            return '<span class="to-page btn btn-primary btn-flat light-blue darken-2 active">'+ this.params.pageNumber +'</span>';
